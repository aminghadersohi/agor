...
CREATE POLICY "session_auto_archive_migration_0101" ON "sessions"
  FOR UPDATE
  USING (current_setting('agor.system_scope', true) = 'session_auto_archive_migration_0101')
  WITH CHECK (current_setting('agor.system_scope', true) = 'session_auto_archive_migration_0101');--> statement-breakpoint
SELECT set_config('agor.system_scope', 'session_auto_archive_migration_0101', true);--> statement-breakpoint
UPDATE "sessions"
...
DROP POLICY "session_auto_archive_migration_0101" ON "sessions";--> statement-breakpoint
