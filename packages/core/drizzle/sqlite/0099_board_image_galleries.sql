...
INSERT INTO `__new_profile_images`("image_id", "user_id", "branch_id", "board_id", "created_by", "original_name", "alt_text", "position", "is_primary", "small_data", "small_content_type", "small_width", "small_height", "large_data", "large_content_type", "large_width", "large_height", "created_at", "updated_at") SELECT "image_id", "user_id", "branch_id", NULL, "created_by", "original_name", "alt_text", "position", "is_primary", "small_data", "small_content_type", "small_width", "small_height", "large_data", "large_content_type", "large_width", "large_height", "created_at", "updated_at" FROM `profile_images`;--> statement-breakpoint
