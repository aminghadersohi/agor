...
// Fork: skipped. This replays upstream's withdrawn 7475feacb SQLite ledger,
// which no fork database has (the fork's SQLite 1790129000214 slot is its own
// 0113_callback_ownership_reconciliation), and the fork does not journal the
// SQLite 0117 file — see context/guides/creating-database-migrations.md.
it.skip('restores API-key source after the 7475feacb watermark (1790129000214)', async () => {
