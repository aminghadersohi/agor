...
/**
 * The path whose *surface* (Home, chat workspace, board canvas) should be
 * rendered — normally just the pathname.
 *
 ...
 * a navigation away from Home / the chat workspace, swapping in the board
 * canvas underneath before the modal paints.
 *
