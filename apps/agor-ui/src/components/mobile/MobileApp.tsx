...
export const MobileApp: React.FC<MobileAppProps> = ({
  ...
  return (
    // Fork-only: the UPS power indicator rides in the shared mobile header
    // accessory slot, across home/board/session/comments routes.
        ...
        >
          <AgentSelectionGrid
            ...
            onSelect={(agent) => {
              ...
              const branch = branchById.get(newSessionBranchId) ?? {
                branch_id: newSessionBranchId,
              };
