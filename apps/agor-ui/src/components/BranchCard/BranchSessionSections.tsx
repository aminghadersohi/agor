...
export const BranchSessionSections: React.FC<BranchSessionSectionsProps> = ({
  ...
  const renderSessionTitle = (
    ...
    return (
      <>
        {/* Fork delta: essential power priority. Upstream's refactor removed
            renderSessionTitleWithFailure, where the fork previously hung this
            badge; this renderer is what its three call sites now share. */}
