...
branches, or gateway channels to each collection. Open any session's **More actions** menu and choose
**Pin to chat collection**, or use **Manage** from Home to edit several collections at once.
...
still apply, and unavailable or archived sessions are not shown on Home.
