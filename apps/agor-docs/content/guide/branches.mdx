...
Local handler/routing tests do not certify an operator's external substrate.
...
ignored personal databases and memory. No new protection flag or inferred path/type
heuristic is added. Non-primary repo branches retain normal policy-controlled Clean;
