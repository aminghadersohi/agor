...
static-tenant, SQLite, local-executor, and `unix_user_mode: simple`. It does not control host
...
without a daemon restart. An admin update uses an exact revision compare-and-swap: if another tab
