...
Agor ships a reviewed catalog of MCP servers with no external catalog service
to configure. Available entries depend on the deployed release; rolling back
can remove entries added in newer versions.
